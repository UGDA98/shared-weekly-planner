...
| Board render | `renderDay`, `renderEventRow`, `renderTaskRow`, `renderBoard` — each delete handler now wires `showUndoToast` | 2394–2729 |
...
Open follow-ups: remove the `weekend` sentinel in ~2 weeks (Watch Out #12); watch board growth (#15).
